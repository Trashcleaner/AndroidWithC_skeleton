 ...
 * File: _coder_my_multiply_info.c
 *
...
/* Include Files */
#include "_coder_my_multiply_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("my_multiply"));
...
/*
 * File trailer for _coder_my_multiply_info.c
 *
 * [EOF]
 */
