...
#include "_coder_my_multiply_mex.h"
 ...
 * Return Type  : void
 */
void my_multiply_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  real_T a;
  real_T b;
 ...
 * Return Type  : void
 */
void my_multiply_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  my_multiply_xil_terminate();
}
 ...
 * Return Type  : void
 */
void my_multiply_initialize(void)
{
  mexFunctionCreateRootTLS();
 ...
 * Return Type  : void
 */
void my_multiply_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_my_multiply_api.c
 *
 * [EOF]
 */
