 ...
 * File: _coder_matlab_func_returning_pointer_info.c
 *
...
/* Include Files */
#include "_coder_matlab_func_returning_pointer_info.h"
...
/*
 * File trailer for _coder_matlab_func_returning_pointer_info.c
 *
 * [EOF]
 */
